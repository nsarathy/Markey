...
public class CreateAccountGUI {
    ...
    public static void AccountType() {
        ...
        String option = (String) JOptionPane.showInputDialog(null, "Would you like to create a Seller or Customer Account?", "Create New Account",
                JOptionPane.PLAIN_MESSAGE, null, accTypeArray, null);
        if (option.equals(accTypeArray[0])) {
            accType = "1";
